...
<body>
	...
	<div class="d-flex align-items-center">
		<input  id="copyLinkInput" class="flex-grow-1" type="text" value="http://localhost:8080/Gestion_de_liste_de_cadeaux_Client/shareList?id=50">
	...
	<div class="container d-flex flex-wrap justify-content-center">
		...
		<table class="table" id="result">
			...
			%>		<tr>
						...
						<td><%= user.getEmail() %></td>
						<td>
							<a class="btn btn-secondary" href="./shareList?id=">Partager</a>
						</td>
					</tr>
			<%} %>
		</table>
